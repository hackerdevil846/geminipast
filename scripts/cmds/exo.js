...
module.exports = {
    config: {
        ...
        shortDescription: {
            en: "𝐺𝑒𝑡 𝑟𝑎𝑛𝑑𝑜𝑚 𝐸𝑋𝑂 𝑖𝑚𝑎𝑔𝑒𝑠"
        },
        longDescription: {
            en: "𝑆𝑒𝑛𝑑𝑠 𝑟𝑎𝑛𝑑𝑜𝑚 𝐸𝑋𝑂 𝑖𝑚𝑎𝑔𝑒𝑠 𝑤𝑖𝑡ℎ 𝑏𝑎𝑐𝑘𝑢𝑝 𝑠𝑢𝑝𝑝𝑜𝑟𝑡"
        },
        guide: {
            en: "{p}exo"
        },
    ...
    onStart: async function({ message }) {
        try {
            ...
            let imageUrls = [];
            const jsonPath = path.join(__dirname, '..', 'data', 'kntl', 'exo.json');
            
            if (fs.existsSync(jsonPath)) {
                try {
                    const exoData = fs.readFileSync(jsonPath, 'utf8');
                    imageUrls = JSON.parse(exoData);
                } catch (parseError) {
                    console.error("𝐸𝑋𝑂 𝐽𝑆𝑂𝑁 𝑝𝑎𝑟𝑠𝑒 𝑒𝑟𝑟𝑜𝑟:", parseError);
                }
            }

            // 🔄 TRY 2: If no images from JSON, use built-in backup links
            if (!Array.isArray(imageUrls) || imageUrls.length === 0) {
                console.log("𝑈𝑠𝑖𝑛𝑔 𝑏𝑎𝑐𝑘𝑢𝑝 𝐸𝑋𝑂 𝑖𝑚𝑎𝑔𝑒𝑠...");
                imageUrls = [
...
"https://i.pinimg.com/originals/7d/c8/42/7dc842d132a637950e465eb5694497a8.jpg"
            ...
            // Send image with EXO-themed caption
            await message.reply({
                body: `🌌 𝐸𝑋𝑂 𝐼𝑁 𝑌𝑂𝑈𝑅 𝑈𝑁𝐼𝑉𝐸𝑅𝑆𝐸! 🌌\n\n✨ 𝐸𝑛𝑗𝑜𝑦 𝑡ℎ𝑖𝑠 𝑟𝑎𝑛𝑑𝑜𝑚 𝐸𝑋𝑂 𝑖𝑚𝑎𝑔𝑒!\n\n𝐸𝑅𝐼 💫 𝐹𝑜𝑟𝑒𝑣𝑒𝑟!`,
                attachment: await global.utils.getStreamFromURL(randomImage)
            });

        } catch (error) {
            console.error("𝐸𝑋𝑂 𝑐𝑜𝑚𝑚𝑎𝑛𝑑 𝑒𝑟𝑟𝑜𝑟:", error);
            await message.reply("❌ 𝐹𝑎𝑖𝑙𝑒𝑑 𝑡𝑜 𝑙𝑜𝑎𝑑 𝐸𝑋𝑂 𝑖𝑚𝑎𝑔𝑒. 𝑃𝑙𝑒𝑎𝑠𝑒 𝑡𝑟𝑦 𝑎𝑔𝑎𝑖𝑛 𝑙𝑎𝑡𝑒𝑟.");
        }
    }
};
