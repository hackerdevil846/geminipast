...
module.exports = {
    ...
    onStart: async function ({ message, event, usersData }) {
        ...
        try {
            ...
            const templatePath = path.join(__dirname, "cache", "canvas", "nayanM.png");
            ...
            // 𝖥𝗂𝗑𝖾𝖽 𝗉𝗈𝗌𝗂𝗍𝗂𝗈𝗇𝗌 𝖿𝗈𝗋 𝗇𝖺𝗒𝖺𝗇𝖬.𝗉𝗇𝗀 𝗍𝖾𝗆𝗉𝗅𝖺𝗍𝖾
            const x1 = 150;
            const y1 = 165;
            const x2 = 675;
            const y2 = 165;
            ...
            outputPath = path.join(__dirname, "cache", `love5_${senderID}_${mentionId}_${timestamp}.png`);
            ...
            console.log("✅ 𝖲𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅𝗅𝗒 𝖼𝗋𝖾𝖺𝗍𝖾𝖽 𝖺𝗇𝖽 𝗌𝖾𝗇𝗍 𝗅𝗈𝗏𝖾𝟧 𝗂𝗆𝖺𝗀𝖾");

        } catch (error) {
            console.error("💥 𝖫𝗈𝗏𝖾𝟧 𝖼𝗈𝗆𝗆𝖺𝗇𝖽 𝖾𝗋𝗋𝗈𝗋:", error.message);
