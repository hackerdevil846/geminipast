...
module.exports = {
    ...
    onStart: async function ({ message, event, usersData }) {
        ...
        try {
            ...
            const templatePath = path.join(__dirname, "cache", "canvas", "asif69.png");
            ...
            try {
                ...
                // 𝖱𝖾𝗌𝗂𝗓𝖾 𝖺𝗏𝖺𝗍𝖺𝗋𝗌
                avatar1.resize(190, 190);
                avatar2.resize(190, 190);
            ...
            // 𝖥𝗂𝗑𝖾𝖽 𝗉𝗈𝗌𝗂𝗍𝗂𝗈𝗇𝗌 𝖿𝗈𝗋 𝖺𝗌𝗂𝖿𝟨𝟫.𝗉𝗇𝗀 𝗍𝖾𝗆𝗉𝗅𝖺𝗍𝖾
            const x1 = 230;
            const y1 = 295;
            const x2 = 770;
            const y2 = 295;
            ...
            outputPath = path.join(__dirname, "cache", `love6_${senderID}_${mentionId}_${timestamp}.png`);
            ...
            console.log("✅ 𝖲𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅𝗅𝗒 𝖼𝗋𝖾𝖺𝗍𝖾𝖽 𝖺𝗇𝖽 𝗌𝖾𝗇𝗍 𝗅𝗈𝗏𝖾𝟨 𝗂𝗆𝖺𝗀𝖾");

        } catch (error) {
            console.error("💥 𝖫𝗈𝗏𝖾𝟨 𝖼𝗈𝗆𝗆𝖺𝗇𝖽 𝖾𝗋𝗋𝗈𝗋:", error.message);
