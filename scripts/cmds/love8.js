...
module.exports = {
    ...
    onStart: async function ({ message, event, usersData }) {
        ...
        try {
            ...
            const templatePath = path.join(__dirname, "cache", "canvas", "zwBuMaE.jpg");
            ...
            try {
                ...
                // 𝖱𝖾𝗌𝗂𝗓𝖾 𝖺𝗏𝖺𝗍𝖺𝗋𝗌 𝗍𝗈 𝖿𝗂𝗍 𝗍𝖾𝗆𝗉𝗅𝖺𝗍𝖾
                avatar1.resize(90, 70);
                avatar2.resize(90, 70);
            ...
            // 𝖥𝗂𝗑𝖾𝖽 𝗉𝗈𝗌𝗂𝗍𝗂𝗈𝗇𝗌 𝖿𝗈𝗋 𝗓𝗐𝖡𝗎𝖬𝖺𝖤.𝗃𝗉𝗀 𝗍𝖾𝗆𝗉𝗅𝖺𝗍𝖾
            const x1 = 215; // 𝖱𝗂𝗀𝗁𝗍 𝗉𝗈𝗌𝗂𝗍𝗂𝗈𝗇 (𝗌𝖾𝗇𝖽𝖾𝗋)
            const y1 = 177;
            const x2 = 76;  // 𝖫𝖾𝖿𝗍 𝗉𝗈𝗌𝗂𝗍𝗂𝗈𝗇 (𝗆𝖾𝗇𝗍𝗂𝗈𝗇𝖾𝖽)
            const y2 = 178;

            // 𝖢𝗈𝗆𝗉𝗈𝗌𝗂𝗍𝖾 𝗂𝗆𝖺𝗀𝖾𝗌
            template.composite(avatar1, x1, y1); // 𝖲𝖾𝗇𝖽𝖾𝗋 𝗈𝗇 𝗋𝗂𝗀𝗁𝗍
            template.composite(avatar2, x2, y2); // 𝖬𝖾𝗇𝗍𝗂𝗈𝗇𝖾𝖽 𝗈𝗇 𝗅𝖾𝖿𝗍

            // 𝖲𝖺𝗏𝖾 𝗈𝗎𝗍𝗉𝗎𝗍
            const timestamp = Date.now();
            outputPath = path.join(__dirname, "cache", `love8_${senderID}_${mentionId}_${timestamp}.png`);
            ...
            // 𝖲𝖾𝗇𝖽 𝗋𝖾𝗌𝗎𝗅𝗍
            await message.reply({
                body: `💝 𝖨 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗌𝗈 𝗆𝗎𝖼𝗁, ${targetName}! 💕`,
                mentions: [
            ...
            console.log("✅ 𝖲𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅𝗅𝗒 𝖼𝗋𝖾𝖺𝗍𝖾𝖽 𝖺𝗇𝖽 𝗌𝖾𝗇𝗍 𝗅𝗈𝗏𝖾𝟪 𝗂𝗆𝖺𝗀𝖾");

        } catch (error) {
            console.error("💥 𝖫𝗈𝗏𝖾𝟪 𝖼𝗈𝗆𝗆𝖺𝗇𝖽 𝖾𝗋𝗋𝗈𝗋:", error.message);
