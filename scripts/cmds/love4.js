...
module.exports = {
    ...
    onStart: async function ({ message, event, usersData }) {
        ...
        try {
            ...
            const templatePath = path.join(__dirname, "cache", "canvas", "asifT.png");
            ...
            outputPath = path.join(__dirname, "cache", `love4_${senderID}_${mentionId}_${timestamp}.png`);
            ...
            console.log("✅ 𝖲𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅𝗅𝗒 𝖼𝗋𝖾𝖺𝗍𝖾𝖽 𝖺𝗇𝖽 𝗌𝖾𝗇𝗍 𝗅𝗈𝗏𝖾𝟦 𝗂𝗆𝖺𝗀𝖾");

        } catch (error) {
            console.error("💥 𝖫𝗈𝗏𝖾𝟦 𝖼𝗈𝗆𝗆𝖺𝗇𝖽 𝖾𝗋𝗋𝗈𝗋:", error.message);
