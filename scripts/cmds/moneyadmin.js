module.exports = {
    config: {
        ...
        category: "𝑠𝑦𝑠𝑡𝑒𝑚",
        shortDescription: {
            en: "𝐶ℎ𝑎𝑛𝑔𝑒 𝑢𝑠𝑒𝑟 𝑚𝑜𝑛𝑒𝑦 𝑏𝑎𝑙𝑎𝑛𝑐𝑒𝑠"
        },
        longDescription: {
            en: "𝑀𝑜𝑑𝑖𝑓𝑦 𝑢𝑠𝑒𝑟 𝑐𝑢𝑟𝑟𝑒𝑛𝑐𝑦 𝑏𝑎𝑙𝑎𝑛𝑐𝑒𝑠 𝑤𝑖𝑡ℎ 𝑣𝑎𝑟𝑖𝑜𝑢𝑠 𝑜𝑝𝑒𝑟𝑎𝑡𝑖𝑜𝑛𝑠"
        },
        guide: {
            en: "{p}moneyadmin [𝑚𝑒/𝑑𝑒𝑙/𝑢𝑖𝑑/@𝑢𝑠𝑒𝑟] [𝑎𝑚𝑜𝑢𝑛𝑡/𝑢𝑠𝑒𝑟𝐼𝐷]"
        },
        countDown: 5,
        dependencies: {}
    },
    ...
    onStart: async function({ message, event, args, usersData }) {
        try {
            ...
            // Invalid command usage
                ...
                return message.reply("ℹ️ 𝑈𝑠𝑎𝑔𝑒:\n𝑚𝑜𝑛𝑒𝑦𝑎𝑑𝑚𝑖𝑛 𝑚𝑒 [𝑎𝑚𝑜𝑢𝑛𝑡]\n𝑚𝑜𝑛𝑒𝑦𝑎𝑑𝑚𝑖𝑛 𝑑𝑒𝑙 𝑚𝑒\n𝑚𝑜𝑛𝑒𝑦𝑎𝑑𝑚𝑖𝑛 @𝑢𝑠𝑒𝑟 [𝑎𝑚𝑜𝑢𝑛𝑡]\n𝑚𝑜𝑛𝑒𝑦𝑎𝑑𝑚𝑖𝑛 𝑢𝑖𝑑 [𝑢𝑠𝑒𝑟𝐼𝐷] [𝑎𝑚𝑜𝑢𝑛𝑡]");
            }

        } catch (error) {
            console.error("𝑀𝑜𝑛𝑒𝑦𝐴𝑑𝑚𝑖𝑛 𝑒𝑟𝑟𝑜𝑟:", error);
