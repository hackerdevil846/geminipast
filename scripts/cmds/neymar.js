module.exports = {
 ...
 aliases: ["njr"],
    ...
    role: 0,
    shortDescription: {
      en: "𝑆𝑒𝑛𝑑 𝑎 𝑟𝑎𝑛𝑑𝑜𝑚 𝑝ℎ𝑜𝑡𝑜 𝑜𝑓 𝑁𝑒𝑦𝑚𝑎𝑟"
    },
    longDescription: {
      en: "𝑆𝑒𝑛𝑑𝑠 𝑏𝑜𝑡ℎ 𝑖𝑚𝑎𝑔𝑒 𝑎𝑛𝑑 𝑈𝑅𝐿 𝑜𝑓 𝑎 𝑟𝑎𝑛𝑑𝑜𝑚 𝑁𝑒𝑦𝑚𝑎𝑟 𝑝ℎ𝑜𝑡𝑜"
    },
    category: "𝑓𝑜𝑜𝑡𝑏𝑎𝑙𝑙",
    guide: {
      en: "{𝑝𝑛}"
  ...
  onStart: async function ({ message }) {
    try {
      ...
      message.reply({
        body: `「 𝑇ℎ𝑒 𝑚𝑎𝑔𝑖𝑐𝑖𝑎𝑛 ℎ𝑎𝑠 𝑎𝑟𝑟𝑖𝑣𝑒𝑑 🎩✨ 」\n𝐼𝑚𝑎𝑔𝑒 𝑈𝑅𝐿: ${randomLink}`,
        attachment: fs.createReadStream(imgPath)
      });

    } catch (error) {
      console.error("𝐸𝑟𝑟𝑜𝑟 𝑠𝑒𝑛𝑑𝑖𝑛𝑔 𝑁𝑒𝑦𝑚𝑎𝑟 𝑖𝑚𝑎𝑔𝑒:", error);
      message.send("𝑆𝑜𝑟𝑟𝑦, 𝑐𝑜𝑢𝑙𝑑𝑛'𝑡 𝑠𝑒𝑛𝑑 𝑡ℎ𝑒 𝑁𝑒𝑦𝑚𝑎𝑟 𝑖𝑚𝑎𝑔𝑒 𝑟𝑖𝑔ℎ𝑡 𝑛𝑜𝑤. 𝑇𝑟𝑦 𝑎𝑔𝑎𝑖𝑛 𝑙𝑎𝑡𝑒𝑟!");
    }
  }
};
